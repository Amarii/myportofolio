<template>
  <button v-on:click="buttonClick" class="menu-toggle" id="menu-toggle" aria-expanded="false">
...
export default {
	methods: {
		buttonClick() {
			let test = document.querySelector(".menu-toggle")
			test.classList.toggle('opened')
		}
	}
};
</script>
